...
####origin  
    def forward(self, input, hg_idx, related_items, label, uid):
        ...
        # print("label111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/label111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(label,f,-1)
        # f.close()
        ...
        # 
        # print("***************************")
        # print("text_embedding111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/text_embedding111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(text_embedding,f,-1)
        # f.close()
        # 
        # 
        ...
        # 
        # print("***************************")
        # print("img_embedding111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/img_embedding111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(img_embedding,f,-1)
        # f.close()
        # 
        # 
        ...
        # text_embedding1 = torch.reshape(text_embedding, (-1, 1, self.emb_size))
        # img_embedding1 = torch.reshape(img_embedding, (-1, 1, self.emb_size))

        # path1 = 'data/'+self.data_name+'/img_embedding111bitch.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(img_embedding1,f,-1)
        # f.close()
        # path2 = 'data/'+self.data_name+'/text_embedding111bitch.pickle'
        # f= open(path2, 'wb')
        # data= pickle.dump(img_embedding1,f,-1)
        # f.close()
        ...
        # text_embedding1 = self.pos_embedding(text_embedding1)
        # img_embedding1 = self.pos_embedding(img_embedding1)
        ...
        # 
        # print("***************************")
        # print("text_gcn_output111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/text_gcn_output111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(text_gcn_output,f,-1)
        # f.close()
        # 
        #         
        # # all_img_emb = torch.stack(all_img_emb, dim=1)
        ...
        # 
        # print("***************************")
        # print("img_gcn_output111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/img_gcn_output111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(img_gcn_output,f,-1)
        # f.close()
        # 
        #
        ...
        text_gcn_output1 = torch.reshape(text_gcn_output, (bsz, 1, -1))
        img_gcn_output1  = torch.reshape(img_gcn_output,  (bsz, 1, -1))
        path1 = 'data/'+self.data_name+'/text_gcn111bitch.pickle'
        f= open(path1, 'wb')
        data= pickle.dump(text_gcn_output,f,-1)
        f.close()
        path2 = 'data/'+self.data_name+'/img_gcn111bitch.pickle'
        f= open(path2, 'wb')
        data= pickle.dump(img_gcn_output,f,-1)
        f.close()
        # 
        ...
        # print("output111")
        # print("***************************")
        # path1 = 'data/'+self.data_name+'/output111.pickle'
        # f= open(path1, 'wb')
        # data= pickle.dump(output,f,-1)
        # f.close()
        # 
        #
