...
class Hypergraph_TransformerConv(MessagePassing):
    ...
    def forward(self, x: Tensor, hyperedge_index: Tensor,
        ...
        out = self.propagate(hyperedge_index, q=hyperedge_attr, k=x, v=x,
                             size=(num_nodes, num_edges))
        out = self.propagate(hyperedge_index.flip([0]), q=x, k=hyperedge_attr,
                             v=x, size=(num_edges, num_nodes))
    ...
    def message(self, q: Tensor, k: Tensor, v: Tensor) -> Tensor:
